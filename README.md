# APA — Proteção Animal de Lagoa da Prata

Site institucional estático desenvolvido em HTML, CSS e JavaScript puros, pronto para publicação no GitHub Pages.
...
No GitHub, acesse **Settings → Pages**, selecione a branch principal e a pasta raiz (`/`).
